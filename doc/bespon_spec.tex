...
\href{http://unicode.org/reports/tr36/}{Unicode Technical Report \#36}, ``Unicode Security Considerations,'' recommends that overrides never be allowed in IRIs.  However, even the implicit directional marks can have a potent effect when operating on punctuation characters.  For example,
\begin{Verbatim}
{"a"="b\u200f", $=!, "\u200fe"="f"}
\end{Verbatim}
renders as
