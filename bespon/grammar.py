...
_RAW_RE_TYPE = [# None type
                ...
                ('unquoted_key_or_list_ascii', '(?:{unquoted_key_ascii}|{open_indentation_list}(?!{path_separator}))'),
                ('unquoted_key_or_list_below_u0590', '(?:{unquoted_key_below_u0590}|{open_indentation_list}(?!{path_separator}))'),
                ('unquoted_key_or_list_unicode', '(?:{unquoted_key_unicode}|{open_indentation_list}(?!{path_separator}))'),
